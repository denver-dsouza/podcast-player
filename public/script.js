document.addEventListener('DOMContentLoaded', () => {
  ...
  function handleFallbackImage(img) {
      const fallbackImage = './podcast.png';
  ...
  function createCard(podcast) {
      ...
      img.src = podcast.image || './podcast.png';
  ...
  function createEpisodeCard(episode) {
      ...
      const img = document.createElement('img');
      img.src = episode.image || episode.feedImage || './podcast.png';
  ...
  function loadPodcast(episode) {
      ...
      image.src = episode.image || episode.feedImage || './podcast.png';
